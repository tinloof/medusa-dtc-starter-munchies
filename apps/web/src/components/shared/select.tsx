    ...
    >
      ...
      >
        ...
        <RadixSelect.Icon className="shrink-0">
          <Icon
            className={cx(
              "data-[size=open] min-w-4 transition-transforms duration-300",
              {
                "rotate-180": open,
              }
            )}
      ...
      <RadixSelect.Portal>
        <RadixSelect.Content
          className={cx(
            "z-100 my-1 max-h-74 w-(--radix-select-trigger-width) origin-top rounded-lg border-[1.5px] border-accent bg-background p-xs data-[state=closed]:animate-select-close data-[state=open]:animate-select-open",
            {
