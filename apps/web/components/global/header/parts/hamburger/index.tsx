      ...
      <Dialog.Portal container={portalContainer}>
        <RemoveScroll>
          <Dialog.Content className="w-screen items-end justify-end overflow-x-hidden bg-background">
            ...
            <div
              className={cx(
                "scrollbar-hide fixed top-[calc(var(--header-height))] left-0 flex h-[calc(100dvh-var(--header-height))] w-screen flex-1 flex-col items-start justify-between overflow-x-hidden overflow-y-scroll bg-background transition-all duration-300",
                {
            ...
            <div
              className={`scrollbar-hide fixed top-[calc(var(--header-height))] left-0 h-[calc(100dvh-var(--header-height))] w-screen transform overflow-x-hidden overflow-y-scroll bg-background transition-all duration-300 ${
