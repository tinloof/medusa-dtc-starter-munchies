...
export const useSanitySyncs = (
  ...
  const fetchSanitySyncs = async (_query?: Record<any, any>) =>
    await sdk.client.fetch<Record<any, any>>("/admin/sanity/syncs", {
      query: _query,
    });
...
export const useSanityDocument = (
  ...
  const fetchSanityProductStatus = async (_query?: Record<any, any>) =>
    await sdk.client.fetch<Record<any, any>>(`/admin/sanity/documents/${id}`, {
      query: _query,
    });
