      ...
      {state !== "success" && (
        <>
          ...
          <form action={action} className="flex flex-col gap-s lg:flex-row">
            <input
              className="newletter-text h-20 w-full max-w-[960px] rounded-lg border-[1.5px] border-accent bg-transparent px-2xl py-[6.5px] font-sans text-body-4xl leading-[140%] tracking-[-0.64px] outline-none placeholder:text-body-4xl placeholder:text-accent placeholder:opacity-60 lg:text-body-8xl lg:tracking-[-0.96px] lg:placeholder:text-body-8xl"
              name="email"
