...
export default function TextPage({
  ...
  return (
    <div className="scroll-mt-header-height flex-col items-center justify-center">
      <section className="py-8xl flex w-full flex-col items-center justify-center gap-xs bg-accent px-xl text-center text-background">
        <Heading
      ...
      <section className="lg:py-8xl mx-auto h-full w-full max-w-max-screen flex-col items-stretch justify-start gap-xl px-m py-2xl lg:w-[89%] lg:flex-row lg:justify-center lg:gap-6xl">
        <div className="flex w-full flex-col justify-center lg:flex-row lg:gap-20">
          {data?.body && (
